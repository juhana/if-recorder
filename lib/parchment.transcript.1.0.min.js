...
"undefined"&&parchment.options.default_story!=""){a.story=parchment.options.default_story;if(!parchment.options.lock_story&&typeof getUrlVars().story!="undefined"&&getUrlVars().story!="")a.story=getUrlVars().story}else if(!parchment.options.lock_story&&typeof getUrlVars().story!="undefined")a.story=getUrlVars().story;if(a.story=="")a.story="(unknown)";else console.log("story: "+a.story);if(!a.collectTranscripts())return false;b=$.toJSON({session:a.sessionId,start:{story:a.story,interpreter:"Parchment",
browser:$.browser.name+" "+$.browser.version+" "+$.os.name}});$.ajax({type:"POST",url:a.saveUrl,data:{data:b},error:function(){a.serverOffline=true},success:function(c){if(c.toLowerCase()!="ok")a.serverOffline=true}});return true},charName:function(b){switch(b){case 8:return"<backspace>";case 9:return"<tab>";case 13:return"<enter>";case 27:return"<esc>";case 32:return"<space>";case 37:return"<left>";case 38:return"<up>";case 39:return"<right>";case 40:return"<down>";case 46:return"<del>";default:return String.fromCharCode(b)}}};
